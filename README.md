...
- `fetch_account_helper(self, type: object, params: object)`
...
- `fetch_orders_by_ids(self, ids: object, symbol: Str = None, params={})`
- `fetch_orders_by_state(self, state: object, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `custom_parse_balance(self, response: object, marketType: object)`
- `describe(self)`
...
- `watch_spot_public(self, channel: object, messageHash: object, params={})`
- `watch_spot_private(self, channel: object, messageHash: object, params={})`
- `watch_swap_public(self, channel: object, messageHash: object, requestParams: object, params={})`
- `watch_swap_private(self, messageHash: object, params={})`
...
- `authenticate(self, subscriptionHash: object, params={})`
