...
- `create_spot_order_request(self, market: Any, type: Any, side: Any, amount: Any, price: Num = None, marginMode: Str = None, params={})`
- `create_spot_order(self, market: Any, type: OrderType, side: Any, amount: Any, price: Num = None, marginMode: Str = None, params={})`
- `create_swap_order(self, market: Any, type: Any, side: Any, amount: Any, price: Num = None, marginMode: Str = None, params={})`
- `fetch_account_helper(self, type: Any, params: Any)`
...
- `fetch_orders_by_ids(self, ids: Any, symbol: Str = None, params={})`
- `fetch_orders_by_state(self, state: Any, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `custom_parse_balance(self, response: Any, marketType: Any)`
- `describe(self)`
...
- `watch_spot_public(self, channel: Any, messageHash: Any, params={})`
- `watch_spot_private(self, channel: Any, messageHash: Any, params={})`
- `watch_swap_public(self, channel: Any, messageHash: Any, requestParams: Any, params={})`
- `watch_swap_private(self, messageHash: Any, params={})`
...
- `authenticate(self, subscriptionHash: Any, params={})`
