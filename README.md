...
- `create_spot_order_request(self, market: object, type: object, side: object, amount: object, price: Num = None, marginMode: Str = None, params={})`
- `create_spot_order(self, market: object, type: OrderType, side: object, amount: object, price: Num = None, marginMode: Str = None, params={})`
- `create_swap_order(self, market: object, type: object, side: object, amount: object, price: Num = None, marginMode: Str = None, params={})`
- `fetch_account_helper(self, type: Str, params: dict)`
...
- `fetch_orders_by_ids(self, ids: list[str], symbol: Str = None, params: dict = {})`
- `fetch_orders_by_state(self, state: float, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `custom_parse_balance(self, response: dict, marketType: Str)`
- `describe(self)`
...
- `spot_private_get_apikeyinfo(request)`
...
- `spot_private_get_rebate_affiliate_campaign(request)`
- `spot_private_get_rebate_affiliate_referral(request)`
- `spot_private_get_rebate_affiliate_subaffiliates(request)`
- `spot_private_get_rebate_affiliate_list(request)`
...
- `spot_private_post_apikeyinfo(request)`
...
- `spot_private_post_strategy_group_uid(request)`
...
- `spot_private_delete_order_all(request)`
- `spot_private_delete_sub_account_apikey(request)`
- `spot_private_delete_strategy_group(request)`
- `spot_private_delete_strategy_group_uid(request)`
...
- `contract_private_get_account_profit_rate_type(request)`
- `contract_private_get_account_asset_analysis_type(request)`
- `contract_private_get_account_feedeductconfigs(request)`
- `contract_private_get_account_asset_analysis_yesterday_pnl(request)`
- `contract_private_get_account_asset_analysis_today_pnl(request)`
- `contract_private_get_account_config_contractfeediscountconfig(request)`
- `contract_private_get_order_fee_details(request)`
- `contract_private_get_account_discounttype(request)`
- `contract_private_get_account_asset_analysis_export(request)`
- `contract_private_get_account_asset_book_order_deal_fee_total(request)`
- `contract_private_get_account_contract_fee_rate(request)`
- `contract_private_get_account_contract_zero_fee_rate(request)`
...
- `contract_private_get_order_list_open_orders(request)`
- `contract_private_get_order_list_history_orders(request)`
- `contract_private_get_order_list_order_deals_v3(request)`
...
- `contract_private_get_order_list_close_orders(request)`
- `contract_private_get_planorder_list_orders(request)`
- `contract_private_get_stoporder_list_orders(request)`
- `contract_private_get_stoporder_open_orders(request)`
...
- `contract_private_get_account_tiered_fee_rate_v2(request)`
- `contract_private_get_trackorder_list_orders(request)`
- `contract_private_get_market_maker_self_trade_blacklist(request)`
- `contract_private_get_market_maker_self_trade_blacklist_search(request)`
- `contract_private_post_account_asset_analysis_v3(request)`
- `contract_private_post_account_asset_analysis_calendar_daily_v3(request)`
- `contract_private_post_account_asset_analysis_calendar_monthly_v3(request)`
- `contract_private_post_account_asset_analysis_recent_v3(request)`
- `contract_private_post_position_change_margin(request)`
- `contract_private_post_position_change_auto_add_im(request)`
- `contract_private_post_position_change_leverage(request)`
- `contract_private_post_position_change_position_mode(request)`
- `contract_private_post_position_reverse(request)`
- `contract_private_post_position_close_all(request)`
- `contract_private_post_order_create(request)`
- `contract_private_post_order_submit(request)`
- `contract_private_post_order_submit_batch(request)`
- `contract_private_post_order_chase_limit_order(request)`
- `contract_private_post_order_change_limit_order(request)`
- `contract_private_post_order_cancel(request)`
- `contract_private_post_order_batch_cancel_with_external(request)`
- `contract_private_post_order_cancel_with_external(request)`
- `contract_private_post_order_cancel_all(request)`
- `contract_private_post_order_open_order_total_count(request)`
- `contract_private_post_order_batch_query_with_external(request)`
- `contract_private_post_account_change_risk_level(request)`
- `contract_private_post_planorder_place(request)`
- `contract_private_post_planorder_place_v2(request)`
- `contract_private_post_planorder_cancel(request)`
- `contract_private_post_planorder_cancel_all(request)`
- `contract_private_post_planorder_change_stop_order(request)`
- `contract_private_post_stoporder_place(request)`
...
- `contract_private_post_trackorder_place(request)`
- `contract_private_post_trackorder_cancel(request)`
- `contract_private_post_trackorder_change_order(request)`
- `contract_private_post_market_maker_self_trade_blacklist_create(request)`
- `contract_private_post_market_maker_self_trade_blacklist_update(request)`
- `contract_private_post_market_maker_self_trade_blacklist_delete(request)`
...
- `broker_private_get_sub_account_status(request)`
...
- `broker_private_get_rebate_taxquery(request)`
...
- `watch_spot_public(self, channel: str, messageHash: str, params: dict = {})`
- `watch_spot_private(self, channel: str, messageHash: str, params: dict = {})`
- `watch_swap_public(self, channel: str, messageHash: str, requestParams: dict, params: dict = {})`
- `watch_swap_private(self, messageHash: str, params: dict = {})`
...
- `authenticate(self, subscriptionHash: Str, params: dict = {})`
